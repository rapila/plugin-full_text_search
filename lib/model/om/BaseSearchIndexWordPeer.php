...
abstract class BaseSearchIndexWordPeer {
	...
	const CLASS_DEFAULT = 'model.SearchIndexWord';
	...
	/**
	 * An identiy map to hold any loaded instances of SearchIndexWord objects.
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::SEARCH_INDEX_ID, self::WORD, self::COUNT, self::CREATED_AT, self::UPDATED_AT, self::CREATED_BY, self::UPDATED_BY, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::SEARCH_INDEX_ID => 0, self::WORD => 1, self::COUNT => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, self::CREATED_BY => 5, self::UPDATED_BY => 6, ),
	 ...
	 *
	 * @param      SearchIndexWord $value A SearchIndexWord object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SearchIndexWordPeer::getOMClass(false);
	...
	{
		return $withPrefix ? SearchIndexWordPeer::CLASS_DEFAULT : SearchIndexWordPeer::OM_CLASS;
	}
	...
	public static function mayOperateOn($oUser, $mObject, $sOperation) {
		...
		return $oUser->hasRole("search_index_words");
	}
	public static function mayOperateOnOwn($oUser, $mObject, $sOperation) {
		return $oUser->hasRole("search_index_words-own");
	}
