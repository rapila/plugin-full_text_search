...
abstract class BaseSearchIndexQuery extends ModelCriteria
{
     ...
     *
     * @return   SearchIndex|SearchIndex[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|SearchIndex[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterBySearchIndexWord($searchIndexWord, $comparison = null)
    {
        ...
        } elseif ($searchIndexWord instanceof PropelObjectCollection) {
            return $this
