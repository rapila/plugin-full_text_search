 ...
 * 
 *
 * @method     SearchIndexQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 * @method     SearchIndexQuery orderByUpdatedBy($order = Criteria::ASC) Order by the updated_by column
 *
 * @method     SearchIndexQuery groupById() Group by the id column
 ...
 * @method     SearchIndexQuery groupByUpdatedBy() Group by the updated_by column
 *
 * @method     SearchIndexQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     SearchIndexQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     SearchIndexQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     SearchIndexQuery leftJoinPage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Page relation
 * @method     SearchIndexQuery rightJoinPage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Page relation
 * @method     SearchIndexQuery innerJoinPage($relationAlias = null) Adds a INNER JOIN clause to the query using the Page relation
 *
 * @method     SearchIndexQuery leftJoinLanguage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Language relation
 * @method     SearchIndexQuery rightJoinLanguage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Language relation
 * @method     SearchIndexQuery innerJoinLanguage($relationAlias = null) Adds a INNER JOIN clause to the query using the Language relation
 *
 * @method     SearchIndexQuery leftJoinUserRelatedByCreatedBy($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method     SearchIndexQuery rightJoinUserRelatedByCreatedBy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByCreatedBy relation
 * @method     SearchIndexQuery innerJoinUserRelatedByCreatedBy($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByCreatedBy relation
 *
 * @method     SearchIndexQuery leftJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method     SearchIndexQuery rightJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByUpdatedBy relation
 * @method     SearchIndexQuery innerJoinUserRelatedByUpdatedBy($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByUpdatedBy relation
 *
 * @method     SearchIndexQuery leftJoinSearchIndexWord($relationAlias = null) Adds a LEFT JOIN clause to the query using the SearchIndexWord relation
 * @method     SearchIndexQuery rightJoinSearchIndexWord($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SearchIndexWord relation
 * @method     SearchIndexQuery innerJoinSearchIndexWord($relationAlias = null) Adds a INNER JOIN clause to the query using the SearchIndexWord relation
 *
 * @method     SearchIndex findOne(PropelPDO $con = null) Return the first SearchIndex matching the query
 * @method     SearchIndex findOneOrCreate(PropelPDO $con = null) Return the first SearchIndex matching the query, or a new SearchIndex object populated from the query conditions when no match is found
 *
 * @method     SearchIndex findOneById(int $id) Return the first SearchIndex filtered by the id column
 ...
 * @method     SearchIndex findOneByUpdatedBy(int $updated_by) Return the first SearchIndex filtered by the updated_by column
 *
 * @method     array findById(int $id) Return SearchIndex objects filtered by the id column
 ...
 * @method     array findByUpdatedBy(int $updated_by) Return SearchIndex objects filtered by the updated_by column
 *
 * @package    propel.generator.model.om
 */
abstract class BaseSearchIndexQuery extends ModelCriteria
{
    
    /**
     * Initializes internal state of BaseSearchIndexQuery object.
     *
     ...
     *
     * @return    SearchIndex|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        if ((null !== ($obj = SearchIndexPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && $this->getFormatter()->isObjectFormatter()) {
    ...
    {
        $this->addUsingAlias(SearchIndexPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(SearchIndexPeer::LANGUAGE_ID, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(SearchIndexPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(SearchIndexPeer::LANGUAGE_ID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterByPageId($pageId = null, $comparison = null)
    {
        if (is_array($pageId)) {
            $useMinMax = false;
            if (isset($pageId['min'])) {
                $this->addUsingAlias(SearchIndexPeer::PAGE_ID, $pageId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($pageId['max'])) {
                $this->addUsingAlias(SearchIndexPeer::PAGE_ID, $pageId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SearchIndexPeer::PAGE_ID, $pageId, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(SearchIndexPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(SearchIndexPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SearchIndexPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByPage($page, $comparison = null)
    {
        if ($page instanceof Page) {
            return $this
                ->addUsingAlias(SearchIndexPeer::PAGE_ID, $page->getId(), $comparison);
        } elseif ($page instanceof PropelCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            return $this
                ->addUsingAlias(SearchIndexPeer::PAGE_ID, $page->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByLanguage($language, $comparison = null)
    {
        if ($language instanceof Language) {
            return $this
                ->addUsingAlias(SearchIndexPeer::LANGUAGE_ID, $language->getId(), $comparison);
        } elseif ($language instanceof PropelCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            return $this
                ->addUsingAlias(SearchIndexPeer::LANGUAGE_ID, $language->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByCreatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(SearchIndexPeer::CREATED_BY, $user->getId(), $comparison);
        } elseif ($user instanceof PropelCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            return $this
                ->addUsingAlias(SearchIndexPeer::CREATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByUserRelatedByUpdatedBy($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(SearchIndexPeer::UPDATED_BY, $user->getId(), $comparison);
        } elseif ($user instanceof PropelCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            return $this
                ->addUsingAlias(SearchIndexPeer::UPDATED_BY, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related SearchIndexWord object
     *
     * @param     SearchIndexWord $searchIndexWord  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return    SearchIndexQuery The current query, for fluid interface
     */
    ...
    {
        if ($searchIndexWord instanceof SearchIndexWord) {
            return $this
                ->addUsingAlias(SearchIndexPeer::ID, $searchIndexWord->getSearchIndexId(), $comparison);
        } elseif ($searchIndexWord instanceof PropelCollection) {
            return $this
                ->useSearchIndexWordQuery()
                ->filterByPrimaryKeys($searchIndexWord->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterBySearchIndexWord() only accepts arguments of type SearchIndexWord or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the SearchIndexWord relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return    SearchIndexQuery The current query, for fluid interface
     */
    public function joinSearchIndexWord($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('SearchIndexWord');
        ...
        if($relationAlias) {
            ...
            $this->addJoinObject($join, 'SearchIndexWord');
        }
    ...
    /**
     * Use the SearchIndexWord relation SearchIndexWord object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return    SearchIndexWordQuery A secondary query class using the current class as primary query
     */
    public function useSearchIndexWordQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSearchIndexWord($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SearchIndexWord', 'SearchIndexWordQuery');
    }
	...
	{
		return $this->addUsingAlias(SearchIndexPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
	}
	...
	{
		return $this->addUsingAlias(SearchIndexPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
	}
