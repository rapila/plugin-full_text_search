...
abstract class BaseSearchIndexWordQuery extends ModelCriteria
{
     ...
     * @param array $key Primary key to use for the query
                         A Primary key composition: [$search_index_id, $word]
     * @param     PropelPDO $con an optional connection object
     *
     * @return   SearchIndexWord|SearchIndexWord[]|mixed the result, formatted by the current formatter
     */
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            SearchIndexWordPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|SearchIndexWord[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterBySearchIndex($searchIndex, $comparison = null)
    {
        if ($searchIndex instanceof SearchIndex) {
            ...
            return $this
                ->addUsingAlias(SearchIndexWordPeer::SEARCH_INDEX_ID, $searchIndex->toKeyValue('Id', 'Id'), $comparison);
        } else {
