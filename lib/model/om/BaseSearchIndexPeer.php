...
abstract class BaseSearchIndexPeer
{
     ...
     * e.g. SearchIndexPeer::$fieldNames[SearchIndexPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SearchIndexPeer::ID, SearchIndexPeer::PAGE_ID, SearchIndexPeer::PATH, SearchIndexPeer::LANGUAGE_ID, SearchIndexPeer::LINK_TEXT, SearchIndexPeer::PAGE_TITLE, SearchIndexPeer::CREATED_AT, SearchIndexPeer::UPDATED_AT, SearchIndexPeer::CREATED_BY, SearchIndexPeer::UPDATED_BY, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. SearchIndexPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SearchIndexPeer::ID => 0, SearchIndexPeer::PAGE_ID => 1, SearchIndexPeer::PATH => 2, SearchIndexPeer::LANGUAGE_ID => 3, SearchIndexPeer::LINK_TEXT => 4, SearchIndexPeer::PAGE_TITLE => 5, SearchIndexPeer::CREATED_AT => 6, SearchIndexPeer::UPDATED_AT => 7, SearchIndexPeer::CREATED_BY => 8, SearchIndexPeer::UPDATED_BY => 9, ),
    ...
    {
        $toNames = SearchIndexPeer::getFieldNames($toType);
        $key = isset(SearchIndexPeer::$fieldKeys[$fromType][$name]) ? SearchIndexPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(SearchIndexPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, SearchIndexPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return SearchIndexPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(SearchIndexPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(SearchIndexPeer::DATABASE_NAME);
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(SearchIndexPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(SearchIndexPeer::$instances[$key])) {
                return SearchIndexPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(SearchIndexPeer::DATABASE_NAME)->getTable(SearchIndexPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(SearchIndexPeer::DATABASE_NAME);
