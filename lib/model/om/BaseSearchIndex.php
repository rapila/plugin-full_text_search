...
abstract class BaseSearchIndex extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|SearchIndexWord[] Collection to store aggregation of SearchIndexWord objects.
     */
    protected $collSearchIndexWords;
    protected $collSearchIndexWordsPartial;
     ...
     */
    protected $searchIndexWordsScheduledForDeletion = null;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SearchIndexPeer::ID;
        }
    ...
    public function setPageId($v)
    {
        ...
        if ($this->page_id !== $v) {
            $this->page_id = $v;
            $this->modifiedColumns[] = SearchIndexPeer::PAGE_ID;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[] = SearchIndexPeer::PATH;
        }
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[] = SearchIndexPeer::LANGUAGE_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SearchIndexPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SearchIndexPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = SearchIndexPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = SearchIndexPeer::UPDATED_BY;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SearchIndexPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SearchIndexQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(SearchIndexPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.custom", array("role_key" => "search_index")));
                }
                ...
                // denyable behavior
                if(!(SearchIndexPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.custom", array("role_key" => "search_index")));
                }

                // extended_timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SearchIndexPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(SearchIndexPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                SearchIndexPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->searchIndexWordsScheduledForDeletion !== null) {
                if (!$this->searchIndexWordsScheduledForDeletion->isEmpty()) {
                    SearchIndexWordQuery::create()
                        ->filterByPrimaryKeys($this->searchIndexWordsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `search_index` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['SearchIndex'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SearchIndex'][serialize($this->getPrimaryKey())] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collSearchIndexWords) {
                $result['SearchIndexWords'] = $this->collSearchIndexWords->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SearchIndexPeer::ID)) $criteria->add(SearchIndexPeer::ID, $this->id);
        ...
        if ($this->isColumnModified(SearchIndexPeer::UPDATED_BY)) $criteria->add(SearchIndexPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(SearchIndexPeer::DATABASE_NAME);
        $criteria->add(SearchIndexPeer::ID, $this->id);
        $criteria->add(SearchIndexPeer::LANGUAGE_ID, $this->language_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SearchIndex (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getSearchIndexWords() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addSearchIndexWord($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SearchIndex Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPage === null && ($this->page_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPage->addSearchIndexs($this);
             */
        }
    ...
    public function getLanguage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLanguage === null && (($this->language_id !== "" && $this->language_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguage->addSearchIndexs($this);
             */
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSearchIndexRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByCreatedBy->addSearchIndexsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addSearchIndexRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addSearchIndexsRelatedByUpdatedBy($this);
             */
        }
    ...
    {
        if ('SearchIndexWord' == $relationName) {
            $this->initSearchIndexWords();
        }
    }

    /**
     * Clears out the collSearchIndexWords collection
     *
    ...
    /**
     * reset is the collSearchIndexWords collection loaded partially
     *
     * @return void
     */
    public function resetPartialSearchIndexWords($v = true)
    {
        $this->collSearchIndexWordsPartial = $v;
    }

    /**
     * Initializes the collSearchIndexWords collection.
     *
     * By default this just sets the collSearchIndexWords collection to an empty array (like clearcollSearchIndexWords());
     ...
     * @return void
     */
    public function initSearchIndexWords($overrideExisting = true)
    {
        if (null !== $this->collSearchIndexWords && !$overrideExisting) {
            return;
        }
        $this->collSearchIndexWords = new PropelObjectCollection();
        $this->collSearchIndexWords->setModel('SearchIndexWord');
    }

    /**
     * Gets an array of SearchIndexWord objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this SearchIndex is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|SearchIndexWord[] List of SearchIndexWord objects
     * @throws PropelException
     */
    public function getSearchIndexWords($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collSearchIndexWordsPartial && !$this->isNew();
        if (null === $this->collSearchIndexWords || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSearchIndexWords) {
                // return empty collection
                $this->initSearchIndexWords();
            } else {
                $collSearchIndexWords = SearchIndexWordQuery::create(null, $criteria)
                ...
                $this->collSearchIndexWords = $collSearchIndexWords;
                $this->collSearchIndexWordsPartial = false;
            }
        }

        return $this->collSearchIndexWords;
    }

    /**
     * Sets a collection of SearchIndexWord objects related by a one-to-many relationship
    ...
    public function setSearchIndexWords(PropelCollection $searchIndexWords, PropelPDO $con = null)
    {
        ...
        $this->searchIndexWordsScheduledForDeletion = unserialize(serialize($searchIndexWordsToDelete));
        ...
        $this->collSearchIndexWords = null;
        foreach ($searchIndexWords as $searchIndexWord) {
            $this->addSearchIndexWord($searchIndexWord);
        }
    ...
    /**
     * Returns the number of related SearchIndexWord objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related SearchIndexWord objects.
     * @throws PropelException
     */
    public function countSearchIndexWords(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collSearchIndexWordsPartial && !$this->isNew();
        if (null === $this->collSearchIndexWords || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collSearchIndexWords) {
    ...
    /**
     * Method called to associate a SearchIndexWord object to this object
     * through the SearchIndexWord foreign key attribute.
     *
     * @param    SearchIndexWord $l SearchIndexWord
     * @return SearchIndex The current object (for fluent API support)
     */
    public function addSearchIndexWord(SearchIndexWord $l)
    {
        if ($this->collSearchIndexWords === null) {
            $this->initSearchIndexWords();
            $this->collSearchIndexWordsPartial = true;
    ...
    /**
     * @param	SearchIndexWord $searchIndexWord The searchIndexWord object to add.
     */
    protected function doAddSearchIndexWord($searchIndexWord)
    {
        $this->collSearchIndexWords[]= $searchIndexWord;
        $searchIndexWord->setSearchIndex($this);
    }
    ...
    {
        if ($this->getSearchIndexWords()->contains($searchIndexWord)) {
            $this->collSearchIndexWords->remove($this->collSearchIndexWords->search($searchIndexWord));
            if (null === $this->searchIndexWordsScheduledForDeletion) {
     ...
     * Otherwise if this SearchIndex is new, it will return
     * an empty collection; or if this SearchIndex has previously
     * been saved, it will retrieve related SearchIndexWords from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SearchIndex.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SearchIndexWord[] List of SearchIndexWord objects
     */
    public function getSearchIndexWordsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SearchIndexWordQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByCreatedBy', $join_behavior);

        return $this->getSearchIndexWords($query, $con);
    }
     ...
     * @return PropelObjectCollection|SearchIndexWord[] List of SearchIndexWord objects
     */
    public function getSearchIndexWordsJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SearchIndexWordQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SearchIndexPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && SearchIndexPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(SearchIndexPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
