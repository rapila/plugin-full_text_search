...
abstract class BaseSearchIndex extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array SearchIndexWord[] Collection to store aggregation of SearchIndexWord objects.
	 */
	...
	public function initRelation($relationName)
	{
		if ('SearchIndexWord' == $relationName) {
			return $this->initSearchIndexWords();
		}
	}
	 ...
	 * @return     PropelCollection|array SearchIndexWord[] List of SearchIndexWord objects
	 * @throws     PropelException
	 */
	public function getSearchIndexWords($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSearchIndexWords || null !== $criteria) {
